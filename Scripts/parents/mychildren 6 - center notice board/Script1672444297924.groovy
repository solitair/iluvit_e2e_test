...
Mobile.comment('학부모 홈 화면에서 어린이집의 공지 게시판 클릭')
...
Mobile.scrollToText('모두의 게시판', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('홈/홈 - 공지 게시판 링크 - android.widget.TextView'), 0)

Mobile.comment('이야기 화면')

Mobile.waitForElementPresent(findTestObject('이야기/프리뷰 - 아이러빗어린이집 - 헤더 타이틀 - android.view.View'), 0)

Mobile.verifyElementText(findTestObject('이야기/원보드 - 공지 게시판 타이틀 - android.widget.TextView'), '공지 게시판')
