...
Mobile.comment('학부모 홈 화면에서 추천 어린이집 중 하나 클릭')
...
Mobile.tap(findTestObject('홈/홈 - 학부모 화면 - 어린이집 추천 목록 첫번째 - android.widget.ImageView'), 0)

Mobile.comment('시설정보 모달')

Mobile.waitForElementPresent(findTestObject('홈/홈 - 시설정보 모달 - 기본정보 텍스트 - android.widget.TextView'), 0)

Mobile.verifyElementText(findTestObject('홈/홈 - 시설정보 모달 - 설명회 텍스트 - android.widget.TextView'), '설명회')

Mobile.tap(findTestObject('홈/홈 - 시설정보 모달 - 닫기 아이콘 - android.widget.TextView'), 0)
