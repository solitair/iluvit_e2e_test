...
Mobile.comment('학부모 홈 화면에서 우리 아이 정보수정 링크 클릭')
...
Mobile.tap(findTestObject('홈/홈 - 학부모 화면 - 아이정보수정 링크 - android.widget.TextView'), 0)

Mobile.comment('우리 아이 정보 화면')

Mobile.waitForElementPresent(findTestObject('마이페이지/우리아이정보 - 헤더 타이틀 - android.widget.TextView'), 0)
