...
Mobile.swipe(0, 974, 0, 400)

Mobile.verifyElementText(findTestObject('시설찾기/주변시설 - 모달 - 설명회 - 신청기간 - android.widget.TextView'), '신청기간')

Mobile.swipe(0, 1000, 0, 500)

Mobile.tap(findTestObject('시설찾기/주변시설 - 모달 - 설명회 - 대기걸기 버튼 - android.widget.TextView'), 0)

'Message Alert.'
Mobile.tap(findTestObject('Alert 알림창 - OK 버튼 - android.widget.Button'), 2, FailureHandling.OPTIONAL)

Mobile.verifyElementVisible(findTestObject('시설찾기/주변시설 - 모달 - 설명회 - 1명 대기중 텍스트 - android.widget.TextView'), 0)

Mobile.tap(findTestObject('시설찾기/주변시설 - 모달 - 설명회 - 신청하기 버튼 - android.widget.TextView'), 0)

'Message Alert.'
Mobile.tap(findTestObject('Alert 알림창 - OK 버튼 - android.widget.Button'), 2, FailureHandling.OPTIONAL)

Mobile.verifyElementVisible(findTestObject('시설찾기/주변시설 - 모달 - 설명회 - 1명 신청중 텍스트 - android.widget.TextView'), 0)

Mobile.tap(findTestObject('시설찾기/주변시설 - 모달 - 설명회 - 대기취소 버튼 - android.widget.TextView'), 0)

'Message Alert.'
Mobile.tap(findTestObject('Alert 알림창 - OK 버튼 - android.widget.Button'), 2, FailureHandling.OPTIONAL)

Mobile.verifyElementVisible(findTestObject('시설찾기/주변시설 - 모달 - 설명회 - 0명 대기중 텍스트 - android.widget.TextView'), 0)

Mobile.tap(findTestObject('시설찾기/주변시설 - 모달 - 설명회 - 신청취소 버튼 - android.widget.TextView'), 0)

'Message Alert.'
Mobile.tap(findTestObject('Alert 알림창 - OK 버튼 - android.widget.Button'), 2, FailureHandling.OPTIONAL)

Mobile.verifyElementVisible(findTestObject('시설찾기/주변시설 - 모달 - 설명회 - 0명 신청중 텍스트 - android.widget.TextView'), 0)
