...
Mobile.comment('학부모 홈 화면에서 모두의 게시판 클릭')
...
Mobile.tap(findTestObject('홈/홈 - 모두의 이야기 링크 - android.widget.TextView'), 0)

Mobile.comment('이야기 화면')

Mobile.waitForElementPresent(findTestObject('이야기/프리뷰 - 모두의 이야기 - 헤더 타이틀 - android.view.View'), 0)
