...
Mobile.setText(findTestObject('시설찾기/주변시설 - 검색 - android.widget.EditText'), '철산', 0)

Mobile.tap(findTestObject('시설찾기/주변시설 - 검색 아이콘 - android.widget.TextView'), 0)

Mobile.delay(2)

Mobile.verifyElementText(findTestObject('시설찾기/주변시설 - 모달 - 철산초등학교병설유치원 이름필드 - android.widget.TextView'), '철산초등학교병설유치원')
