...
Mobile.tap(findTestObject('시설찾기/주변시설 - 입학설명회 - 검색필터모달 - 시도 선택 - android.view.ViewGroup'), 0)

Mobile.tap(findTestObject('시설찾기/주변시설 - 입학설명회 - 검색필터모달 - 대전시 텍스트 - android.widget.CheckedTextView'), 0)

Mobile.tap(findTestObject('시설찾기/주변시설 - 입학설명회 - 검색필터모달 - 시군구 선택 - android.view.ViewGroup'), 0)

Mobile.tap(findTestObject('시설찾기/주변시설 - 입학설명회 - 검색필터모달 - 유성구 텍스트 - android.widget.CheckedTextView'), 0)

Mobile.tap(findTestObject('시설찾기/주변시설 - 입학설명회 - 검색필터모달 - 추가 버튼 - android.widget.TextView'), 0)

Mobile.scrollToText('필터적용', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('시설찾기/주변시설 - 입학설명회 - 검색필터모달 - 필터적용 버튼 - android.widget.TextView'), 0)

Mobile.comment('입학설명회 화면')

Mobile.verifyElementText(findTestObject('시설찾기/주변시설 - 입학설명회 - 어린이집 텍스트 - android.widget.TextView'), '어린이집')

Mobile.verifyElementText(findTestObject('시설찾기/주변시설 - 입학설명회 - 청결 텍스트 - android.widget.TextView'), '#청결')

Mobile.verifyElementText(findTestObject('시설찾기/주변시설 - 입학설명회 - 체육 텍스트 - android.widget.TextView'), '#체육')

Mobile.verifyElementText(findTestObject('시설찾기/주변시설 - 입학설명회 - 캠핑 텍스트 - android.widget.TextView'), '#캠핑')

Mobile.verifyElementText(findTestObject('시설찾기/주변시설 - 입학설명회 - 천주교 텍스트 - android.widget.TextView'), '#천주교')

Mobile.verifyElementText(findTestObject('시설찾기/주변시설 - 입학설명회 - 만1세 텍스트 - android.widget.TextView'), '만 1세')

Mobile.verifyElementText(findTestObject('시설찾기/주변시설 - 입학설명회 - 대전광역시유성구 텍스트 - android.widget.TextView'), '대전광역시 유성구')
...
Mobile.tap(findTestObject('시설찾기/주변시설 - 입학설명회 - 검색필터모달 - 전체 태그 - android.widget.TextView'), 0)
...
Mobile.tap(findTestObject('시설찾기/주변시설 - 입학설명회 - 검색필터모달 - 대전광역시유성구 지우기 - android.widget.TextView'), 0)
...
Mobile.verifyElementNotVisible(findTestObject('시설찾기/주변시설 - 입학설명회 - 대전광역시유성구 텍스트 - android.widget.TextView'), 0)
